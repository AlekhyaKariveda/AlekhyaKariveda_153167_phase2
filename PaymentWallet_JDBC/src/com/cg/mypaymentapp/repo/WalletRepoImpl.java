...
public class WalletRepoImpl implements WalletRepo 
{
	...
	public Customer findOne(String mobileNo) 
	{
		...
		try( Connection con = WalletDBUtil.getConnection()) {
			try {		     
		    con.setAutoCommit(false);
			PreparedStatement pstm = con.prepareStatement("select * from WalletCustomer where mobileNo=?");
	...
	public Customer depositAmount(String mobileNo, BigDecimal amount) {
		...
		try( Connection con = WalletDBUtil.getConnection()) {
			try{
			    ...
			    PreparedStatement pstm1 = con.prepareStatement("update WalletCustomer set walletBalance=? where mobileNo=?");
	...
	public Customer fundTransfer(String sourceMobileNo, String targetMobileNo,
		...
		try( Connection con = WalletDBUtil.getConnection()) {
			try{
				con.setAutoCommit(false);
				PreparedStatement pstm3 = con.prepareStatement("select * from WalletCustomer where mobileNo=?");
			    ...
			    PreparedStatement pstm4 = con.prepareStatement("update WalletCustomer set walletBalance=? where mobileNo=?");
